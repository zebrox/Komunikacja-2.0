...
gulp.task ('sass', function() {
    return gulp.src('src/css/*.scss') // wskazujemy skąd brać pliki scss - /**/ ze wszystkich podfolderach *.scss - wszystkie *.scss
        ...
        .pipe(gulp.dest('build/css/main.css')) //przeznaczenie do którego wklejamy skompilowane css-y (folder, nazwa pliku będzie zbieżna z nazwą pliku scss)
});
